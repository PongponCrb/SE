...
{/* ===================================================================================================================================================== */}
          ...
          <View style={{marginTop: 22,position:'absolute' }}>
            <Modal isVisible={this.state.isModalVisible} style={{backgroundColor: 'transparent',alignItems:'center'}}>
              <TouchableOpacity style={styles.hideModal1} onPress={this._hideModal}>
              </TouchableOpacity>
              <View style={styles.typeView}>
                <View style={{width:'100%',flexDirection:'row'}}>
                  <View style={{flex:0.5,alignItems:'flex-start'}}>
                    <Text style={styles.txtType}>ชนิดใหม่</Text>
                  </View>
                  <View style={{flex:0.5,alignItems:'flex-end',justifyContent:'flex-end'}}>
                    <Text style={styles.txtLengthNewType}>{this.state.lengthnewType} / 15</Text>
                  </View>
                </View>
                <View style={styles.onChangetxtView}/>
                <TextInput placeholderTextColor='#868686' placeholder='ชนิดของคุณ ...' maxLength={15} multiline={true} style={{padding:10,fontFamily:'kanitRegular'}} onChangeText={(text)=>this.onChangeText(text)}><Text style={{color:'#868686',fontSize:14}}>{this.state.newType}</Text></TextInput>
                  <TouchableOpacity style={{position:'absolute',bottom:0,right:0}} onPress={this.onPressAddType}>
                    <Text style={styles.txtAddType}>เพิ่ม</Text>
                  </TouchableOpacity>
              </View>
            </Modal>
          </View>
          ...
          <View style={{marginTop: 22,position:'absolute' }}>
            <Modal isVisible={this.state.isModalVisible2} style={{backgroundColor: 'transparent',alignItems:'center'}}>
              <TouchableOpacity style={styles.hideModal2} onPress={this._hideModal2}>
              </TouchableOpacity>
              <View style={styles.delView}>
                <Text style={styles.deltxt}>คุณต้องการลบมันใช่มั้ย</Text>
                <View style={styles.delViewInside}>
                  <TouchableOpacity style={styles.delTypeBtn} onPress={()=>{(this.state.mode=='TYPE')?this.onPressDeleteType(this.state.element1):this.onPressDeleteMenu(this.state.element1,this.state.element2,this.state.element3)}}>
                    <Text style={styles.confirm}>ตกลง</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.hideModal2Cancel} onPress={this._hideModal2}>
