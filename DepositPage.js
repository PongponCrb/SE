...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, FlatList, ScrollView, Alert, AsyncStorage, Picker } from 'react-native';
        ...
        return (
          <View style={styles.container}>
            ...
            <View style={{flex:0.85,marginLeft:15,marginRight:15}}>
              ...
              <View style={{height:40,marginTop:10}}>
                <FlatList
                  ...
                  renderItem={({item,index}) =>
                    <TouchableOpacity style={[{backgroundColor:(this.state.pushBtn==index)?'#FF2D55':'#404040'},this.styles.btn1]} onPress={()=>this.onPressPrice(index)}>
              ...
              {(this.state.check==0)
                ?<TextInput style={this.styles.textin} placeholder='จำนวนเงิน 50.00 - 20,000.00 บาท' placeholderTextColor='#737070' keyboardType='numeric' value={(this.state.value>0)?String(this.state.value):''} onChangeText={(value)=>this.onChangePrice(value)}/>
                :<View style={this.styles.view4}>
              ...
              <ScrollView>
                ...
                ? <View style={{width:'100%',marginTop:10,justifyContent:'center',alignItems:'center'}}>
                    ...
                    <View style={this.styles.view1}>
                      <Text style={this.styles.text1}>ชื่อบัญชีที่โอน (ชื่อต้องเป็นภาษาอังกฤษเท่านั้น)</Text>
                      <TextInput style={{color:'white',fontSize:13}} value={this.state.name} onChangeText={(name)=>this.setState({name})}/>
                    </View>
                    <View style={this.styles.view1}>
                      <Text style={this.styles.text1}>ธนาคารที่โอน</Text>
                      <Picker selectedValue={this.state.bank} itemStyle={this.styles.pick} style={this.styles.item}
                      onValueChange={(itemValue)=>{this.setState({bank:itemValue})}}>
                        {this.state.picker}
                      </Picker>
                    </View>
                    <View style={this.styles.view1}>
                      <Text style={this.styles.text1}>เลขที่บัญชีที่โอน</Text>
                    ...
                    <View style={this.styles.view1}>
                      <Text style={this.styles.text1}>วันเวลาที่โอน</Text>
              ...
              <TouchableOpacity style={this.styles.btn3} onPress={this.onPressOK}>
            ...
            <View style={{marginTop: 22,position:'absolute' }}>
              <Modal isVisible={this.state.isModalVisible} style={{backgroundColor: 'transparent',alignItems:'center'}}>
                <TouchableOpacity style={this.styles.btn4} onPress={this._hideModal}>
                </TouchableOpacity>
                <View style={this.styles.view2}>
                  ...
                  <View style={this.styles.view3}>
                    <TouchableOpacity style={this.styles.btn2} onPress={this.onPressCreateQR}>
                      <Text style={{color:'#2BF658',fontSize:20,fontFamily:'kanitMedium'}}>ตกลง</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.styles.btn2} onPress={this._hideModal}>
            ...
            <View style={{marginTop: 22,position:'absolute' }}>
              <Modal isVisible={this.state.isModalVisible2} style={{backgroundColor: 'transparent',alignItems:'center'}}>
                <TouchableOpacity style={this.styles.btn4} onPress={this._hideModal2}>
                </TouchableOpacity>
                <View style={this.styles.view2}>
                  <Text style={{color:'white',fontSize:23,fontFamily:'kanitBold',padding:10,paddingTop:30}}>ต้องการยกเลิกรายการหรือไม่</Text>
                  <View style={this.styles.view3}>
                    <TouchableOpacity style={this.styles.btn2} onPress={this.onPressBack}>
                      <Text style={{color:'#2BF658',fontSize:30,fontFamily:'kanitMedium'}}>ตกลง</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.styles.btn2} onPress={this._hideModal2}>
