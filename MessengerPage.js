              ...
              <FlatList
                ...
                renderItem = {({item}) =>
                  ...
                  ? <View style={styles.loadMoreView}>
                      <TouchableOpacity style={styles.loadMoreBtn} onPress={()=>this.btn_Loadmore()}>
                  ...
                  : <View style={{justifyContent:'center',alignItems:'center'}}>
                      <TouchableOpacity style={styles.onPressChat} onPress={()=>this.onPressChat(item)}>
                        <Image source={{ uri: item.restaurants.Logo }} style={styles.image}></Image>
                        <View style={{flex:1,padding:10}}>
                          <View style={{flexDirection:'row'}}>
                            <View style={styles.resNameView}>
                              <Text style={styles.txtRes}>{item.restaurants.restaurant.Name}</Text>
                            </View>
                            <View style={styles.changeTimeView}>
                              <Text style={styles.txtChangeTime}>{this.changeTime(item.newchat.Time)}</Text>
                              <MaterialIcons style={{color:'#DB3966'}} name={'navigate-next'} size={25}/>
                            </View>
                          </View>
                          <Text style={styles.txtChangeLengthMsg}>{this.changeLengthMessage(item.newchat.Message)}</Text>
                        </View>
                      </TouchableOpacity>
